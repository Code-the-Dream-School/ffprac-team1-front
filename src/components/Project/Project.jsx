      ...
      <div className="my-10">
        <div className="my-4 p-8 border border-transparent rounded-lg bg-gray/5">
          ...
          <p className="font-sans font-extralight text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, dolor repellat error
            soluta perspiciatis accusantium provident aperiam officiis alias? Deserunt at, saepe aut
            adipisci eos debitis omnis incidunt maiores animi. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Unde, dolor repellat error soluta perspiciatis accusantium
            provident aperiam officiis alias? Deserunt at, saepe aut adipisci eos debitis omnis
            incidunt maiores animi. Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde,
            dolor repellat error soluta perspiciatis accusantium provident aperiam officiis alias?
            Deserunt at, saepe aut adipisci eos debitis omnis incidunt maiores animi.
          </p>
        </div>
        <div className="my-4 p-8 border border-transparent rounded-lg bg-gray/5">
          <h3 className="text-lg text-green/80">Technologies and languages:</h3>
          {project.technologies.map((item, index) => (
            <span key={index} className="font-sans font-extralight text-[14px]">
              {' '}
              {item + ', '}{' '}
            </span>
          ))}
