...
const Register = () => {
  ...
  return (
    <div className="p-1 max-w-md mx-auto bg-black text-white rounded-lg shadow min-h-[83vh]">
      <div className="text-2xl text-center text-green/80 pt-[25%] pb-10">Sign Up</div>
